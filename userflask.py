...
def addrec():
    if request.method == 'POST':
         ...
         con=sql.connect("user.db")
         cur = con.cursor()
         create_table = """CREATE TABLE IF NOT EXISTS userlogin (
                                        usernm text PRIMARY KEY,
...
def addregi():
    if request.method == 'POST':
         ...
         con=sql.connect("user.db")
         cur = con.cursor()
         create_table = """CREATE TABLE IF NOT EXISTS userregist (
                                        firstname text NOT NULL,
                                        lastname text,
                                        dateofbirth text,
                                        email text,
                                        ...
                                        address text,
                                        city text,
                                        X_percentage integer,
                                        XII_percentage integer,
